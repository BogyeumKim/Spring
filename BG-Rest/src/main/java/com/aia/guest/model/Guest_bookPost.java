...
public class Guest_bookPost {
	...
	public Guest_bookPost(int guest_idx, String guest_writer, String guest_text, String guest_photo, String guest_date,
	...
	public String toString() {
		return "Guest_bookPost [guest_idx=" + guest_idx + ", guest_writer=" + guest_writer + ", guest_text="
				+ guest_text + ", guest_photo=" + guest_photo + ", guest_date=" + guest_date + ", guest_like="
				+ guest_like + ", guest_hits=" + guest_hits + ", x=" + x + ", y=" + y + ", member_radius="
				+ member_radius + ", member_img=" + member_img + ", guest_addr=" + guest_addr + "]";
	}
