...
public class MemberRegController {
	...
	@Autowired
	BCryptPasswordEncoder passwrodEncoder;
	...
	public String getMemberReg(
		...
		System.out.println("Spring Secuiry 암호화");
		System.out.println(passwrodEncoder.encode(regRequest.getUpw()));
		System.out.println(passwrodEncoder.encode(regRequest.getUpw()).length());
